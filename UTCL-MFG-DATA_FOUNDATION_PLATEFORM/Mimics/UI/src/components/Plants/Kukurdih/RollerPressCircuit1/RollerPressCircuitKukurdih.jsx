...
export const RollerPressCircuitKukurdih = () => {
  return (
    <div className="RollerPressCircuitKukurdih w-100 h-100 position-relative">
      <PipeWithCircles
      ...
      <div className="position-absolute single-text-3 d-flex">
        <div className="d-flex">
          ...
          <TextContainerWithWrapWord
            data={{
              useClass: "text-dark bg-secondary ml-1",
              label: "V",
            }}
          />
        </div>
      ...
      <div className="d-flex position-absolute single-text-16">
        <div className="triangle-with-squares text-center">
          ...
          />
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("CM_561CN1_LS")}`}
            text="L"
            label="CM_561CN1_LS"
          />
        </div>
        <div className="triangle-with-squares text-center">
          ...
          />
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("CM_561CN2_LS")}`}
            text="L"
            label="CM_561CN2_LS"
          />
        </div>
      ...
      <div className=" position-absolute single-text-18 text-center">
        ...
        <div className="d-flex">
          <div className="squareplustri d-flex justify-content-center align-items-end"></div>
          <div className="squareplustri d-flex justify-content-center align-items-end"></div>
        </div>
      </div>
      ...
      <div className="position-absolute single-text-26 d-flex">
        <div className="yellowpolygon d-flex justify-content-center align-items-center">
          <MotorCircleDigitalTag
            className={`text-dark digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              { runLabel: "CM_561FM1_RUN", healthyLabel: "CM_561FM1_PH" }
            )}`}
            label="CM_561FM1_RUN"
            text="SFM"
          />
      ...
      <div className="position-absolute single-text-67 d-flex">
        <div>
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("CM_531BI2_LSH")}`}
            text="H"
            label="CM_531BI2_LSH"
          />
          <MotorCircleDigitalTag
      ...
      <div className="position-absolute single-text-69 d-flex">
        <div className="d-flex ">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              { runLabel: "CM_561BE1_Aux_RUN", healthyLabel: "CM_561BE1_Aux_PH" }
            )}`}
      ...
      <div className="position-absolute single-text-72 d-flex align-items-baseline">
        <div className="roller-drum d-flex justify-content-center align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
      ...
      <div className="position-absolute single-text-95 d-flex">
        ...
        <div className="text-center">
          <MotorCircleDigitalTag
            className={`line-circle digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              { runLabel: "CM_591FN5A_RUN", healthyLabel: "CM_591FN5A_PH" }
            )}`}
            label="CM_591FN5A_RUN"
          />
          <TextContainerWithWrapWord
            data={{
              useClass: "text-dark mt-1",
        ...
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CM_561SG2_OLS",
                closeLabel: "CM_561SG2_CLS",
              }
            )}`}
            label="CM_561SG2_OLS"
          />
      ...
      <div className="d-flex position-absolute single-text-114 align-items-start">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
              { openLabel: "CM_561LD3_EOLS", closeLabel: "CM_561LD3_ECLS" }
            )}`}
            label="CM_561LD3_EOLS"
          />
          <div className="yellowline-Vr position-relative"></div>
      ...
      <div className="d-flex position-absolute single-text-115 align-items-end">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
              { openLabel: "CM_561LD2_EOLS", closeLabel: "CM_561LD2_ECLS" }
            )}`}
            label="CM_561LD2_EOLS"
          />
          <div className="yellowline-Vr position-relative"></div>
        ...
        <div className="d-flex  align-items-center">
          ...
          <div className="dot-square-line d-flex flex-column align-items-center ml-4">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
                {
                  openLabel: "CM_561SG3_OLS",
                  closeLabel: "CM_561SG3_CLS",
                }
              )}`}
              label="CM_561SG3_OLS"
            />
        ...
        <div className="d-flex  align-items-center t">
          ...
          <div className="dot-square-line d-flex flex-column align-items-center ml-4">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                {
                  openLabel: "CM_561SG5_EOLS",
                  closeLabel: "CM_561SG5_ECLS",
                  healthyLabel: "CM_561SG5_PH",
                }
              )}`}
        ...
        <div className="d-flex  align-items-center">
          ...
          <div className="dot-square-line d-flex flex-column align-items-center ml-4">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
                {
                  openLabel: "CM_571SG1_OLS",
                  closeLabel: "CM_571SG1_CLS",
                }
              )}`}
              label="CM_571SG1_OLS"
            />
        ...
        <div className="d-flex  align-items-center t">
          ...
          <div className="dot-square-line d-flex flex-column align-items-center ml-4">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
                {
                  openLabel: "CM_571SG2_OLS",
                  closeLabel: "CM_571SG2_CLS",
                }
              )}`}
              label="CM_571SG2_OLS"
            />
      ...
      <div className="d-flex position-absolute single-text-119 align-items-start">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CM_571SG3_OLS",
                closeLabel: "CM_571SG3_CLS",
              }
            )}`}
            label="CM_571SG3_OLS"
          />
      ...
      <div className="d-flex position-absolute single-text-120 align-items-center">
        ...
        <div className="dot-square-line d-flex flex-column align-items-center ml-4">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CM_591SG1_OLS",
                closeLabel: "CM_591SG1_CLS",
              }
            )}`}
            label="CM_591SG1_OLS"
          />
      ...
      <div className="d-flex position-absolute single-text-122 align-items-center">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useGateTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CM_531SG2_EOLS",
                closeLabel: "CM_531SG2_ECLS",
      ...
      <div className="d-flex position-absolute single-text-129 align-items-center">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CM_561LD1_EOLS",
                closeLabel: "CM_561LD1_ECLS",
              }
            )}`}
            label="CM_561LD1_EOLS"
          />
      ...
      <div className=" position-absolute single-text-130 align-items-center">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CM_561SD1_EOLS",
                closeLabel: "CM_561SD1_ECLS",
              }
            )}`}
      ...
      <div className="position-absolute single-text-132 text-center">
        <TextContainerWithWrapWord
          data={{
            useClass: "text-dark",
            label: "SV FIRING",
        ...
        />
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("NA")} mt-1`}
          label="NA"
        />
      </div>
      ...
      <TextContainerWithWrapWord
        data={{
          useClass: "text-dark  position-absolute single-text-135 bg-secondary",
          label: "TO SILO",
        }}
      />
      <BlackContainer
      ...
      />
      <div className="position-absolute single-text-137 d-flex flex-column">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
            { runLabel: "NA", healthyLabel: "NA" }
          )}`}
      ...
      <div className="position-absolute single-text-138 text-center">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
