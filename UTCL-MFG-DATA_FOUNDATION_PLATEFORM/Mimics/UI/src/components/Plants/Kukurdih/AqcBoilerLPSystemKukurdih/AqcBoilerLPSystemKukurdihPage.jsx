import { TextContainerWithWrapWord, BlackContainer, MotorCircleDigitalTag, PipeWithCircles, MimicCaret } from "../../../index";
import { useColorStatus, useBVTagsColorStatusForNewPlantScreens } from "../../../../utils";

export const AqcBoilerLPSystemKukurdihPage = () => {
  return (
    <div className=" AqcBoilerLPSystem w-100 h-100 position-relative">
      ...
      <div className=" position-absolute single-text-3 d-flex">
        <div className="c-grey-img-2"></div>
        <div className="c-grey-img-2"></div>
        <div className="c-grey-img-2"></div>
        <div className="c-grey-img-2"></div>
        <div className="c-grey-img-2"></div>
      ...
      <div className="position-absolute single-text-11">
        <div className=" mt-2">
          ...
          <BlackContainer
            data={{
              label: "W1_PH_HP_FDW_FCV_501A_SP",
        ...
        <div className=" mt-2">
          ...
          <BlackContainer
            data={{
              label: "W1_PH_HP_FDW_FCV_501B_SP",
              useClass: "greenTxt mt-3",
              unit: "",
              unitColor: "unitColor",
            }}
        ...
        <div className=" mt-2">
          ...
          <BlackContainer
            data={{
              label: "W1_AQC_LP_FDW_FCV_501A_SP",
              useClass: "greenTxt mt-3",
              unit: "",
              unitColor: "unitColor",
            }}
        ...
        <div className=" mt-2">
          ...
          <BlackContainer
            data={{
              label: "W1_AQC_LP_FDW_FCV_501B_SP",
              useClass: "greenTxt mt-3",
              unit: "",
              unitColor: "unitColor",
            }}
      ...
      <div className="position-absolute single-text-22">
        ...
        <BlackContainer
          data={{
            label: "W1_AQC_LP_MAS_PCV_616_SP",
        ...
        <div className="d-flex">
          <div className="text-center">
            <MimicCaret
              ...
              firstCaretClass={`fa-solid fa-caret-right d-block digital-tag ${useBVTagsColorStatusForNewPlantScreens({ openLabel: "NA", closeLabel: "NA" })}`}
              secondCaretClass={`fa-solid fa-caret-left d-block  digital-tag  ${useBVTagsColorStatusForNewPlantScreens({ openLabel: "NA", closeLabel: "NA" })}`}
              label="NA"
            />
      ...
      <div className="position-absolute single-text-29">
        <div className="text-center">
          ...
          <MimicCaret
            parentClass="d-flex tringle-item justify-content-center"
            firstCaretClass={`fa-solid fa-caret-right d-block digital-tag ${useBVTagsColorStatusForNewPlantScreens({ openLabel: "W1_AQC_MOV618A_OLS", closeLabel: "W1_AQC_MOV618A_CLS" })}`}
            secondCaretClass={`fa-solid fa-caret-left d-block  digital-tag  ${useBVTagsColorStatusForNewPlantScreens({ openLabel: "W1_AQC_MOV618A_OLS", closeLabel: "W1_AQC_MOV618A_CLS" })}`}
            label="W1_AQC_MOV618A_OLS"
          />
        </div>
        <div className="d-flex mt-2">
          <MotorCircleDigitalTag className={`square digital-tag ml-2 ${useColorStatus("W1_AQC_MOV618A_OLS")} ml-2`} label="W1_AQC_MOV618A_OLS" />
          <MotorCircleDigitalTag className={`square digital-tag ml-2 ${useColorStatus("W1_AQC_MOV618A_CLS")} ml-2`} label="W1_AQC_MOV618A_CLS" />
        </div>
      </div>
      <div className="position-absolute single-text-30">
        <div className="d-flex mt-2">
          <MotorCircleDigitalTag className={`square digital-tag mr-3 ${useColorStatus("W1_AQC_LP_CDS_MOV_035_CLS")}`} text="C" label="W1_AQC_LP_CDS_MOV_035_CLS" />
          <MotorCircleDigitalTag className={`square digital-tag ml-2 ${useColorStatus("W1_AQC_LP_CDS_MOV_035_OLS")} ml-5`} text="O" label="W1_AQC_LP_CDS_MOV_035_OLS" />
        </div>
      ...
      <div className="position-absolute single-text-31">
        <div className="text-center d-flex justify-content-center align-items-center">
          <MimicCaret
            ...
            firstCaretClass={`fa-solid fa-caret-down d-block digital-tag ${useBVTagsColorStatusForNewPlantScreens({ openLabel: "NA", closeLabel: "NA" })}`}
            secondCaretClass={`fa-solid fa-caret-up d-block  digital-tag  ${useBVTagsColorStatusForNewPlantScreens({ openLabel: "NA", closeLabel: "NA" })}`}
            label="NA"
          />
          <TextContainerWithWrapWord
            data={{
        ...
        <div className="text-center d-flex justify-content-center align-items-center">
          <MimicCaret
            parentClass="tringle-item"
            firstCaretClass={`fa-solid fa-caret-down d-block digital-tag ${useBVTagsColorStatusForNewPlantScreens({ openLabel: "W1_AQC_MOV040_OLS", closeLabel: "W1_AQC_MOV040_CLS" })}`}
            secondCaretClass={`fa-solid fa-caret-up d-block  digital-tag  ${useBVTagsColorStatusForNewPlantScreens({ openLabel: "W1_AQC_MOV040_OLS", closeLabel: "W1_AQC_MOV040_CLS" })}`}
            label="W1_AQC_MOV040_OLS"
          />
          <TextContainerWithWrapWord
            data={{
              useClass: "text-dark ml-2",
        ...
        <div className="d-flex mt-5 mr-5">
          <MotorCircleDigitalTag className={`square digital-tag  ${useColorStatus("W1_AQC_MOV040_OLS")}`} label="W1_AQC_MOV040_OLS" />
          <MotorCircleDigitalTag className={`square digital-tag ml-5 ${useColorStatus("W1_AQC_MOV040_CLS")}`} label="W1_AQC_MOV040_CLS" />
        </div>
      </div>
      ...
      <div className="position-absolute single-text-34">
        ...
        <div className="d-flex position-absolute single-text-35">
          <MotorCircleDigitalTag className={`square digital-tag mr-3 ${useColorStatus("W1_AQC_LP_CDS_MOV_036_CLS")}`} text="C" label="W1_AQC_LP_CDS_MOV_036_CLS" />
          <MotorCircleDigitalTag className={`square digital-tag ml-2 ${useColorStatus("W1_AQC_LP_CDS_MOV_036_OLS")} ml-5`} text="O" label="W1_AQC_LP_CDS_MOV_036_OLS" />
        </div>
        <div className="d-flex position-absolute single-text-36">
          <MotorCircleDigitalTag className={`square digital-tag mr-3 ${useColorStatus("W1_AQC_LP_CDS_MOV_037_CLS")}`} text="C" label="W1_AQC_LP_CDS_MOV_037_CLS" />
          <MotorCircleDigitalTag className={`square digital-tag ml-2 ${useColorStatus("W1_AQC_LP_CDS_MOV_037_OLS")} ml-5`} text="O" label="W1_AQC_LP_CDS_MOV_037_OLS" />
        </div>
