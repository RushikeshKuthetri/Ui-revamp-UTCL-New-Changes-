...
export const CrusherStorageKukurdihPage = () => {
  return (
    <div className="cmh-kotputli cs-kukurdih w-100 h-100 position-relative">
      ...
      {/*-----------Totalizers tag Added by TRID AI--------------------------- */}
      <div className="position-absolute single-text-201">
        <TextContainerWithWrapWord
          data={{
            useClass: "text-dark mt-1",
            label: "211BW1_totalizer",
          }}
        />
        <BlackContainer
          data={{
            label: "CR_211BW1_totalizer",
            useClass: "greenTxt mt-1",
            unit: "TPH",
            unitColor: "unitColor",
          }}
      ...
      <div className="position-absolute single-text-202">
        <TextContainerWithWrapWord
          data={{
            useClass: "text-dark mt-1",
            label: "211BW2_totalizer",
          }}
        />
        <BlackContainer
          data={{
            label: "CR_211BW2_totalizer",
            useClass: "greenTxt mt-1",
            unit: "TPH",
            unitColor: "unitColor",
          }}
      ...
      <div className="position-absolute single-text-203">
        <TextContainerWithWrapWord
          data={{
            useClass: "text-dark mt-1",
            label: "211BW3_totalizer",
          }}
        />
        <BlackContainer
          data={{
            label: "CR_211BW3_totalizer",
            useClass: "greenTxt mt-1",
            unit: "TPH",
            unitColor: "unitColor",
          }}
