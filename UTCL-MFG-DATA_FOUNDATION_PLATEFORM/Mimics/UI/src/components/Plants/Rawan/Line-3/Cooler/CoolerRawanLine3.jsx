...
export const CoolerRawanLine3 = () => {
  return (
    <div className="Rawan-L3-Cooler cooler-maihar-l4 w-100 h-100 position-relative">
      <PipeWithCircles
      ...
      <div className="position-absolute single-text-2 d-flex">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("CL_473EP1_HP1_LS")}`}
          label="CL_473EP1_HP1_LS"
          text="L"
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("CL_473EP1_HP2_LS")}`}
          label="CL_473EP1_HP2_LS"
          text="L"
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("CL_473EP1_HP3_LS")}`}
          label="CL_473EP1_HP3_LS"
          text="L"
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("CL_473EP1_HP4_LS")}`}
          label="CL_473EP1_HP4_LS"
          text="L"
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("CL_473EP1_HP5_LS")}`}
          label="CL_473EP1_HP5_LS"
          text="L"
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("CL_473EP1_HP6_LS")}`}
          label="CL_473EP1_HP6_LS"
          text="L"
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("CL_473EP1_HP7_LS")}`}
          label="CL_473EP1_HP7_LS"
          text="L"
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("CL_473EP1_HP8_LS")}`}
          label="CL_473EP1_HP8_LS"
          text="L"
        />
      </div>
            ...
            <div className="d-flex align-items-center justify-content-center">
              <MotorCircleDigitalTag
                className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
                  { runLabel: "CL_473MT1_RUN", healthyLabel: "CL_473MT1_PH" }
                )}`}
                label="CL_473MT1_RUN"
              />
              <TextContainerWithWrapWord
      ...
      <div className="position-absolute single-text-11 d-flex">
        <div className="border p-2 text-center">
          ...
          <div className="d-flex justify-content-around mt-1">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus("CL_473CC1_LS31")}`}
              label="CL_473CC1_LS31"
              text="L"
            />
            <MotorCircleDigitalTag
            ...
            />
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus("CL_473CC1_LS32")}`}
              label="CL_473CC1_LS32"
              text="L"
            />
          </div>
        </div>
        ...
        <div className="border p-2 text-center">
          ...
          <div className="d-flex justify-content-around mt-1">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus("CL_473CC1_LS33")}`}
              label="CL_473CC1_LS33"
              text="L"
            />
            <MotorCircleDigitalTag
              className={`square digital-tag ${useColorStatus(
            ...
            />
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus("CL_473CC1_LS34")}`}
              label="CL_473CC1_LS34"
              text="L"
            />
          </div>
        </div>
        ...
        <div className="border p-2 text-center">
          ...
          <div className="d-flex justify-content-around mt-1">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus("CL_473CC1_LS35")}`}
              label="CL_473CC1_LS35"
              text="L"
            />
            <MotorCircleDigitalTag
              className={`square digital-tag ${useColorStatus(
            ...
            />
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus("CL_473CC1_LS36")}`}
              label="CL_473CC1_LS36"
              text="L"
            />
          </div>
        </div>
      ...
      <div className=" position-absolute single-text-12 d-flex">
        <div className="d-flex">
          <div className="triangle-with-squares d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP1_LFT_LS"
              )}`}
              label="CL_473CC1_HP1_LFT_LS"
              text="L"
            />
          </div>
          <div className="triangle-with-squares ml d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP1_RGT_LS"
              )}`}
              label="CL_473CC1_HP1_RGT_LS"
              text="L"
            />
          </div>
        </div>
        <div className="d-flex">
          <div className="triangle-with-squares d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP2_LFT_LS"
              )}`}
              label="CL_473CC1_HP2_LFT_LS"
              text="L"
            />
          </div>
          <div className="triangle-with-squares ml d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP2_RGT_LS"
              )}`}
              label="CL_473CC1_HP2_RGT_LS"
              text="L"
            />
          </div>
        </div>
        <div className="d-flex">
          <div className="triangle-with-squares d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP3_LFT_LS"
              )}`}
              label="CL_473CC1_HP3_LFT_LS"
              text="L"
            />
          </div>
          <div className="triangle-with-squares ml d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP3_RGT_LS"
              )}`}
              label="CL_473CC1_HP3_RGT_LS"
              text="L"
            />
          </div>
        </div>
        <div className="d-flex">
          <div className="triangle-with-squares d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP4_LFT_LS"
              )}`}
              label="CL_473CC1_HP4_LFT_LS"
              text="L"
            />
          </div>
          <div className="triangle-with-squares ml d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP4_RGT_LS"
              )}`}
              label="CL_473CC1_HP4_RGT_LS"
              text="L"
            />
          </div>
        </div>
        <div className="d-flex">
          <div className="triangle-with-squares d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP5_LFT_LS"
              )}`}
              label="CL_473CC1_HP5_LFT_LS"
              text="L"
            />
          </div>
          <div className="triangle-with-squares ml d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP5_RGT_LS"
              )}`}
              label="CL_473CC1_HP5_RGT_LS"
              text="L"
            />
          </div>
        </div>
        <div className="d-flex">
          <div className="triangle-with-squares d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP6_LFT_LS"
              )}`}
              label="CL_473CC1_HP6_LFT_LS"
              text="L"
            />
          </div>
          <div className="triangle-with-squares ml d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP6_RGT_LS"
              )}`}
              label="CL_473CC1_HP6_RGT_LS"
              text="L"
            />
          </div>
        </div>
        <div className="d-flex">
          <div className="triangle-with-squares d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP7_LFT_LS"
              )}`}
              label="CL_473CC1_HP7_LFT_LS"
              text="L"
            />
          </div>
          <div className="triangle-with-squares ml d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP7_RGT_LS"
              )}`}
              label="CL_473CC1_HP7_RGT_LS"
              text="L"
            />
          </div>
        </div>
        <div className="d-flex">
          <div className="triangle-with-squares d-flex align-items-center justify-content-center pt-2 ">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP8_LFT_LS"
              )}`}
              label="CL_473CC1_HP8_LFT_LS"
              text="L"
            />
          </div>
          <div className="triangle-with-squares ml d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP8_RGT_LS"
              )}`}
              label="CL_473CC1_HP8_RGT_LS"
              text="L"
            />
          </div>
        </div>
        <div className="d-flex">
          <div className="triangle-with-squares d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP9_LFT_LS"
              )}`}
              label="CL_473CC1_HP9_LFT_LS"
              text="L"
            />
          </div>
          <div className="triangle-with-squares ml d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP9_RGT_LS"
              )}`}
              label="CL_473CC1_HP9_RGT_LS"
              text="L"
            />
          </div>
        </div>
        <div className="d-flex">
          <div className="triangle-with-squares d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP10_LFT_LS"
              )}`}
              label="CL_473CC1_HP10_LFT_LS"
              text="L"
            />
          </div>
          <div className="triangle-with-squares ml d-flex align-items-center justify-content-center pt-2">
            ...
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useColorStatus(
                "CL_473CC1_HP10_RGT_LS"
              )}`}
              label="CL_473CC1_HP10_RGT_LS"
              text="L"
            />
          </div>
        </div>
      ...
      <div className="position-absolute single-text-19 d-flex flex-column ">
        <div className="text-center">
          ...
          />
          <MotorCircleDigitalTag
            className={`line-circle grey-color digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "CL_473FNH_RUN",
                healthyLabel: "CL_473FNH_PH",
              }
            )} `}
            label="CL_473FNH_RUN"
          />
          ...
          <div className="dot-square-line d-flex flex-column align-items-center">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
                {
                  openLabel: "CL__473LD3_OLS",
                  closeLabel: "CL__473LD3_CLS",
                }
              )}`}
              label="CL__473LD3_OLS"
            />
        ...
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
                {
                  openLabel: "CL__473LD4_OLS",
                  closeLabel: "CL__473LD4_CLS",
                }
              )}`}
              label="CL__473LD4_OLS"
            />
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
      ...
      <div className="position-absolute single-text-21">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CL_473LD1_OLS",
                closeLabel: "CL_473LD1_CLS",
              }
            )}`}
            label="CL_473LD1_OLS"
          />
      ...
      <div className="position-absolute single-text-26">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CL_473LD5_OLS",
                closeLabel: "CL_473LD5_CLS",
              }
            )}`}
            label="CL_473LD5_OLS"
          />
      ...
      <div className="position-absolute single-text-28">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CL_473LD6_OLS",
                closeLabel: "CL_473LD6_CLS",
              }
            )}`}
            label="CL_473LD6_OLS"
          />
      ...
      <div className="position-absolute single-text-63 ">
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CL_473BF1_RUN")}`}
          label="CL_473BF1_RUN"
        />
      </div>
      ...
      <div className="position-absolute single-text-71 d-flex">
        ...
        <div className="text-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              { runLabel: "CL_473RC4", healthyLabel: "CL_473RC4" }
            )}`}
            label="CL_473RC4"
            text=""
          />
      ...
      <div className="position-absolute single-text-72 d-flex">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("CL_473RC3_ZSS")}`}
          label="CL_473RC3_ZSS"
          text="Z"
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("CL_473LQ1_GRS_LS")}`}
          label="CL_473LQ1_GRS_LS"
          text="L"
        />
      </div>
      ...
      <div className="position-absolute single-text-75 d-flex">
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CL_473TDE2_ZS1")}`}
          label="CL_473TDE2_ZS1"
        />
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CL_473TDE2_ZS2")}`}
          label="CL_473TDE2_ZS2"
        />
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CL_473TDE2_ZS3")}`}
          label="CL_473TDE2_ZS3"
        />
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CL_473TDE2_FS1")}`}
          label="CL_473TDE2_FS1"
        />
      </div>
      <div className="position-absolute single-text-76 d-flex">
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CL_473TDE1_ZS1")}`}
          label="CL_473TDE1_ZS1"
        />
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CL_473TDE1_ZS2")}`}
          label="CL_473TDE1_ZS2"
        />
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CL_473TDE1_ZS3")}`}
          label="CL_473TDE1_ZS3"
        />
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CL_473TDE1_FS1")}`}
          label="CL_473TDE1_FS1"
        />
      </div>
      ...
      <div className="d-flex position-absolute single-text-82 ">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("KL_PA_Start")} `}
          label="KL_PA_Start"
          text="S"
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("KL_FlameDetected")} `}
      ...
      <div className="position-absolute single-text-85 d-flex">
        ...
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("WHRS_RunFB")}`}
          label="WHRS_RunFB"
          text="H"
        />
      </div>
      <div className="position-absolute single-text-86 ">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "CL_493BS1_RUN",
                healthyLabel: "CL_493BS1_PH",
              }
            )}`}
            label="CL_493BS1_RUN"
          />
      ...
      <div className="position-absolute single-text-87">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("CL_493TS1")}`}
            label="CL_493TS1"
          />
          <div className="yellowline-Vr position-relative"></div>
          <div className={`square grey-color`}></div>
      ...
      <div className="position-absolute single-text-88">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "CL_OWRBG_MOTOR_RUN",
                healthyLabel: "CL_OWRBG_MOTOR_PH",
              }
            )}`}
            label="CL_OWRBG_MOTOR_RUN"
          />
          <div className="yellowline-Vr position-relative"></div>
          <div className={`square grey-color`}></div>
        </div>
        ...
        <div className="text-center">
          <div>
            <MotorCircleDigitalTag
              className={`line-circle digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
                {
                  runLabel: "CL_473FN2A_RUN",
                  healthyLabel: "CL_473FN2A_PH",
                }
              )}`}
              label="CL_473FN2A_RUN"
            />
          </div>
          <TextContainerWithWrapWord
            data={{
        ...
        <div className="text-center ml-1">
          <div>
            <MotorCircleDigitalTag
              className={`line-circle digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
                {
                  runLabel: "CL_473FNB_RUN",
                  healthyLabel: "CL_473FNB_PH",
                }
              )}`}
              label="CL_473FNB_RUN"
            />
