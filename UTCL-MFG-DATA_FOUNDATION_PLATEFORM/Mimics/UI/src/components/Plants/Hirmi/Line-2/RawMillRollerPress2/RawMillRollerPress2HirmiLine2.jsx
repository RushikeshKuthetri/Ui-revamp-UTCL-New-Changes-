...
export const RawMillRollerPress2HirmiLine2 = () => {
  return (
    <div className="RawMillRollerPress1Hirmil2 RMRP2Hirmil2 w-100 h-100 position-relative">
      ...
      <div className="position-absolute single-text-9">
        ...
        <div className="d-flex justify-content-between mt-1">
          ...
          <BlackContainer
            data={{
              label: "RM2_R_STA_SP_PRESS_CORR_L",
              useClass: "greenTxt ml-2",
              unit: "bar",
              unitColor: "unitColor",
            }}
        ...
        <div className="d-flex justify-content-between mt-1">
          ...
          <BlackContainer
            data={{
              label: "RM2_R_STA_SP_PRESS_CORR_R",
              useClass: "greenTxt ml-2",
              unit: "bar",
              unitColor: "unitColor",
            }}
      ...
      <div className="position-absolute single-text-10">
        ...
        <div className="d-flex justify-content-between mt-1">
          ...
          <BlackContainer
            data={{
              label: "RM2_R_STA_OP_TIM_HR_LOAD",
              useClass: "greenTxt ml-2",
              unit: "h",
              unitColor: "unitColor",
            }}
        ...
        <div className="d-flex justify-content-between mt-1">
          ...
          <BlackContainer
            data={{
              label: "RM2_R_STA_OP_TIM_MIN_LOAD",
              useClass: "greenTxt ml-2",
              unit: "min",
              unitColor: "unitColor",
            }}
      ...
      <div className="d-flex align-items-end position-absolute single-text-12">
        <div className="mr-3">
          ...
          />
          <MotorCircleDigitalTag
            className={`dot p-3 digital-tag ${useColorStatus("RM2_362MD3")}`}
            label="RM2_362MD3"
            text="M"
          />
        </div>
      ...
      <div className="d-flex align-items-end position-absolute single-text-13">
        <div className="mr-3">
          ...
          />
          <MotorCircleDigitalTag
            className={`dot p-3 digital-tag ${useColorStatus("RM2_362MD4")}`}
            label="RM2_362MD4"
            text="M"
          />
        </div>
      ...
      <div className="d-flex position-absolute single-text-17">
        ...
        <MotorCircleDigitalTag
          ...
          label="RM2_362LQ5_M01"
        />
        <MotorCircleDigitalTag
          className={`line-circle ml-2 digital-tag ${useColorStatus(
            "RM2_362LQ5_M02"
          )}`}
          label="RM2_362LQ5_M02"
        />
        <TextContainerWithWrapWord
          data={{
            useClass: "text-dark ml-1",
      ...
      />
      <div className="d-flex flex-column ustify-content-between position-absolute single-text-34">
        <BlackContainer
          data={{
            label: "RM2_R_INP_LQ05_T01",
            useClass: "greenTxt",
            unit: "°C",
            unitColor: "unitColor",
          }}
      ...
      <BlackContainer
        data={{
          label: "RM2_362HD_M01_NO_STR_TD",
          useClass: "greenTxt position-absolute single-text-37",
          unit: "",
          unitColor: "unitColor",
        }}
      />
      <div className="d-flex justify-content-between position-absolute single-text-38">
        <BlackContainer
          data={{
            label: "RM2_R_INP_HD02_P02",
            useClass: "greenTxt",
            unit: "bar",
            unitColor: "unitColor",
          }}
