...
// import { MimicCaret } from "../../../Mimic Caret/MimicCaret";
import {
  useColorStatus,
...
export const RollerPressCircuitKarurPage = () => {
  return (
    <div className="RollerPressCircuitKarurPage w-100 h-100 position-relative">
     ...
     <div className=" position-absolute  single-text-2 d-flex">
      <div>
        ...
        <span className={`dot greenDot mt-1 p-2 ${"RM_362BC2"} `}></span>
          </div>
          <TextContainerWithWrapWord
          data={{
...
<div>
<MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_532MT1_PH")}`}
          label="SM_532MT1_PH"
        /></div>
<div>
<MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_532MT1_MD")}`}
          label="SM_532MT1_MD"
        />
</div>
</div>
        ...
        <div className=" position-absolute  single-text-3">
          ...
          <MotorCircleDigitalTag
          className={`square digital-tag mr-2 ${useColorStatus("SM_532BC1_NDE_MG")}`}
          label="SM_532BC1_NDE_MG"
        />
...
<div>
<MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_532BC1_VGTU")}`}
          label="SM_532BC1_VGTU"
        />
        </div>
<TextContainerWithWrapWord
 data={{
...
<div>
<MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_532BC1_DE_MG")}`}
          label="SM_532BC1_DE_MG"
        />
</div>
</div>
...
<div>
  <MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_532BC2_DE_MG")}`}
          label="SM_532BC2_DE_MG"
        /></div>
<div>
<MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_532BC2_NDE_MG")}`}
          label="SM_532BC2_NDE_MG"
        />
</div>
<div>
<MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_532BC2_VGTU")}`}
          label="SM_532BC2_VGTU"
        />
</div>
</div>
    ...
    <div className=" position-absolute single-text-5">
        <div className="d-flex">
          <span>
          <MotorCircleDigitalTag
          className={`square digital-tag mr-1 ${useColorStatus("SM_532DG1_OLS")}`}
          label="SM_532DG1_OLS"
        /></span>
        <div>
         <MotorCircleDigitalTag
          ...
          label=""
        />
          <div className="gray-green-red-img red-img ml-1"></div>
          </div>
          <span>
          <MotorCircleDigitalTag
          className={`square digital-tag ml-1 ${useColorStatus("SM_532DG1_CLS")}`}
          label="SM_532DG1_CLS"
        />
          </span>
        </div>
      ...
      <span>
          <MotorCircleDigitalTag
          className={`square digital-tag mt-5 ${useColorStatus("SM_532GA1_CLS")}`}
          text="CLS"
          label="SM_532GA1_CLS"
        /></span>
      </div>
...
<span>
<MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-1 ${useColorStatus("SM_532BI1_LS")}`}
          label="SM_532BI1_LS"
        />
</span>
</div>
...
/>
      ...
      <span>
      <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-1 ${useColorStatus("SM_532VN1_ZSS")}`}
          label="SM_532VN1_ZSS"
        />
        </span>
      <span className={`greenDot mt-1 ml-1 ${"51RF2_MR"}`}>M</span>
      </div>
      <TextContainerWithWrapWord
 data={{
...
/>
      ...
      <div className="position-absolute single-text-8 d-flex">
        <div>
        <MotorCircleDigitalTag
          className={`square digital-tag mt-3 mr-4 ${useColorStatus("SM_532SG2_CLS")}`}
          label="SM_532SG2_CLS"
        />
        </div>
        <div>
        <div className="dot-square-line d-flex flex-column align-items-center">
        <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_532SG2_OLS", closeLabel: "SM_532SG2_CLS" })}`}></div>
        ...
        <div>
        <MotorCircleDigitalTag
          className={`square digital-tag mt-3 ml-4 ${useColorStatus("SM_532SG2_OLS")}`}
          label="SM_532SG2_OLS"
        />
        </div>
...
/>
      <div><span className={`greenDot  ml-3 ${"51RF2_MR"}`}>M</span></div>
      <TextContainerWithWrapWord
 data={{
   useClass: "text-dark mt-2 ml-2 bg-danger",
   label: "532CR1",
 }}
/>
      </div>
...
<div>
<MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_532BC3_DE_MG")}`}
          label="SM_532BC3_DE_MG"
        />
</div>
<div>
<MotorCircleDigitalTag
          className={`square digital-tag ml-5 ${useColorStatus("SM_532BC3_NDE_MG")}`}
          label="SM_532BC3_NDE_MG"
        />
</div>
<div>
<MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_532BC3_VGTU")}`}
          label="SM_532BC3_VGTU"
        />
</div>
<TextContainerWithWrapWord
 data={{
...
/>
<div className={`square grey-color ml-4`}></div>
    ...
    <div className="position-absolute single-text-11 d-flex">
        <div>
          ...
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_532SG3_OLS", closeLabel: "SM_532SG3_CLS" })}`}></div>
      ...
      <TextContainerWithWrapWord
        ...
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_532SG1_EOLS", closeLabel: "SM_532SG1_ECLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
      ...
      <div className="d-flex">
        <div>
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("SM_532SG1_ECLS")}`}
          label="SM_532SG1_ECLS"
        />
        </div>
        <div>
        <MotorCircleDigitalTag
          className={`square digital-tag ml-5 ${useColorStatus("SM_532SG1_EOLS")}`}
          label="SM_532SG1_EOLS"
        />
        </div>
        </div>
        <div className="roller-jcb mt-2"></div>
        </div>
        ...
        <div class="hpipecircle flex-column py-1 position-absolute single-text-15">
          ...
          <TextContainerWithWrapWord
 data={{
   useClass: "text-dark bg-white ml-3",
   label: "ZSS",
 }}
/>
...
/>
          ...
          <TextContainerWithWrapWord
 data={{
   useClass: "text-dark bg-white mr-3",
   label: "ZSS2",
 }}
/>
<div>
...
/>
        ...
        <div class="position-absolute single-text-19">
          <div className="d-flex">
          <span className={`dot greenDot p-2 ${"RM_362BC2"} `}>M</span>
...
<span>
<MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-1 ${useColorStatus("SM_562BI2_LS")}`}
          text="LS"
          label="SM_562BI2_LS"
        /></span>
<span>
<MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-1 ${useColorStatus("SM_562BI2_PH")}`}
          text="PH"
          label="SM_562BI2_PH"
        /></span>
</div>
...
/>
      ...
      <div className="position-absolute single-text-21 ">
        ...
        <span>
        <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-2 ${useColorStatus("SM_562GA1_CLS")}`}
          text="CLS"
          label="SM_562GA1_CLS"
        /></span>
      <span>
        <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-2 ${useColorStatus("SM_562GA1_OLS")}`}
          text="OLS"
          label="SM_562GA1_OLS"
        /></span>
        </div>
        ...
        <div className="d-flex ml-5">
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562SG4_EOLS", closeLabel: "SM_562SG4_ECLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
      ...
      <span>
        <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-2 ${useColorStatus("SM_562SG4_ECLS")}`}
          text="ECLS"
          label="SM_562SG4_ECLS"
        /></span>
      <span>
        <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-2 ${useColorStatus("SM_562SG4_EOLS")}`}
          text="EOLS"
        ...
        <span>
        <MotorCircleDigitalTag
          className={`square digital-tag mr-2 ${useColorStatus("SM_532GA1_OLS")}`}
          text="OLS"
          label="SM_532GA1_OLS"
        /></span>
          <BlackContainer
...
<BlackContainer
            ...
            <span>
            <MotorCircleDigitalTag
          className={`square digital-tag mr-2 ${useColorStatus("SM_562BC1_NDE_MG")}`}
...
<span>
<MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_562BC1_DE_MG")}`}
    ...
    <span>
    <MotorCircleDigitalTag
          className={`square digital-tag mr-2 ${useColorStatus("SM_562SC1_ZSS")}`}
          text="ZSS"
          label="SM_562SC1_ZSS"
        />
      </span>
...
<div>
    <span>
    <MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_562BC1_ZSS")}`}
          text="ZSS"
          label="SM_562BC1_ZSS"
        />
    </span>
...
<span>
<MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-1 ${useColorStatus("SM_562BI1_LS")}`}
          label="SM_562BI1_LS"
        />
  </span>
  <span>
<MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-1 ${useColorStatus("SM_562BI1_PH")}`}
          label="SM_562BI1_PH"
        />
  </span>
</div>
...
<span>
<MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-1 ${useColorStatus("SM_562SG1_CLS")}`}
          label="SM_562SG1_CLS"
        />
...
<span>
<MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-1 ${useColorStatus("SM_562SG1_OLS")}`}
          label="SM_562SG1_OLS"
        />
</span>
</div>
      ...
      <div class="pipeHr position-relative rounded-pill"><span>
      <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562AB1_PS")}`}
          label="SM_562AB1_PS"
        /></span></div>
      <TextContainerWithWrapWord
            data={{
      ...
      <div class="pipeHr position-relative rounded-pill"><span>
      <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562AB2_PS")}`}
          label="SM_562AB2_PS"
        /></span></div>
      <TextContainerWithWrapWord
            data={{
      ...
      <div class="pipeHr position-relative rounded-pill"><span>
      <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562AB3_PS")}`}
          label="SM_562AB3_PS"
        /></span></div>
      <TextContainerWithWrapWord
            data={{
      ...
      <div className="position-absolute single-text-36 d-flex">
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`square digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562SG1_OLS", closeLabel: "SM_562SG1_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
      ...
      <span>
      <MotorCircleDigitalTag
          className={`square digital-tag mt-3 mr-4 ${useColorStatus("SM_562SG5_ECLS")}`}
          label="SM_562SG5_ECLS"
        /></span></div>
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562SG5_EOLS", closeLabel: "SM_562SG5_ECLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
          </div>
          ...
          <span>
          <MotorCircleDigitalTag
          className={`square digital-tag mt-3 ml-4 ${useColorStatus("SM_562SG5_EOLS")}`}
      ...
      <div className="d-flex justify-content-center align-items-center img-92 position-absolute single-text-41">
        <div className="m-lines">
          <div className="d-flex">
            <div
              className={`m-line-left  green-color${("")}`}
            ></div>

            <div
              className={`m-line-right green-color ml-4 ${("")}`}
            ></div>
          </div>
      ...
      <div class="pipeHr position-relative rounded-pill"><span>
        <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562AB4_PS")}`}
          label="SM_562AB4_PS"
        /></span></div>
      <div class="pipeHr position-relative rounded-pill">
      <span>
        <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562AB5_PS")}`}
          label="SM_562AB5_PS"
        /></span></div>
      </div>
    ...
    <span>
    <MotorCircleDigitalTag
          className={`square digital-tag mr-2 ${useColorStatus("SM_562BC2_DE_MG")}`}
          label="SM_562BC2_DE_MG"
        /></span>
    <span>
    <MotorCircleDigitalTag
          className={`square digital-tag mr-2 ${useColorStatus("SM_562BC2_NDE_MG")}`}
...
<span>
<MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("SM_562SC2_ZSS")}`}
          text="ZSS"
          label="SM_562SC2_ZSS"
        /></span>
</div>
    ...
    <div className="position-absolute single-text-45 ">
      <div className="d-flex">
      <span><MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("SM_562SG2_ECLS")}`}
      ...
      <div className="position-absolute single-text-46 ">
        <div>
         ...
         <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_532SG3_CLS")}`}
          label="SM_532SG3_CLS"
        /></span>
         <span><MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-5 ${useColorStatus("SM_532SG3_OLS")}`}
          label="SM_532SG3_OLS"
        /></span>
         </div>
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`square digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562SG3_OLS", closeLabel: "SM_562SG3_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
        <TextContainerWithWrapWord
          ...
          <span>
          <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562BE1_LS1")}`}
          text="BLLS"
          label="SM_562BE1_LS1"
        /></span>
        </div>
      ...
      <div className="position-absolute single-text-47 ">
        ...
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`square digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562SG7", closeLabel: "SM_562SG7" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
  ...
  <div>
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562LD2_OLS", closeLabel: "SM_562LD2_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
        <div className="d-flex">
         <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562LD2_ECLS")}`}
          label="SM_562LD2_ECLS"
        /></span>
         <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-3 ${useColorStatus("SM_562LD2_EOLS")}`}
  ...
  <div>
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562LD3_OLS", closeLabel: "SM_562LD3_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
        ...
        <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562LD3_ECLS")}`}
          label="SM_562LD3_ECLS"
        /></span>
         <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-3 ${useColorStatus("SM_562LD3_EOLS")}`}
  ...
  <div>
        ...
        <TextContainerWithWrapWord
          ...
          />
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562LD4_OLS", closeLabel: "SM_562LD4_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
        ...
        <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562LD4_ECLS")}`}
          label="SM_562LD4_ECLS"
        /></span>
         <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-3 ${useColorStatus("SM_562LD4_EOLS")}`}
  ...
  <div>
        ...
        <TextContainerWithWrapWord
          ...
          />
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562LD6_OLS", closeLabel: "SM_562LD6_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
        ...
        <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562LD6_ECLS")}`}
          label="SM_562LD6_ECLS"
        /></span>
         <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-3 ${useColorStatus("SM_562LD6_EOLS")}`}
  ...
  <div>
        ...
        <TextContainerWithWrapWord
          ...
          />
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562LD5_OLS", closeLabel: "SM_562LD5_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
        ...
        <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562LD5_ECLS")}`}
          label="SM_562LD5_ECLS"
        /></span>
         <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-4 ${useColorStatus("SM_562LD5_EOLS")}`}
        ...
        <div className="position-absolute single-text-55 d-flex">
          ...
          <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mx-auto ${useColorStatus("SM_562BF1_HP1_LS")}`}
        ...
        /></span>
          ...
          <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mx-auto ${useColorStatus("SM_562BF1_HP2_LS")}`}
        ...
        /></span>
          ...
          <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mx-auto ${useColorStatus("SM_562BF1_HP3_LS")}`}
        ...
        /></span>
          ...
          <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mx-auto ${useColorStatus("SM_562BF1_HP4_LS")}`}
...
/>
<span className={`dot greenDot mt-1 mx-auto ${"51RF2_MR"}`}></span>
          </div>
...
/>
<span className={`dot greenDot ml-3 mt-3 ${"51RF2_MR"}`}>M</span>
</div>
        </div>
        <div className="position-absolute single-text-66">
        <span className={`line-circle grey-color  ml-3 mt-3 ${"51RF2_MR"}`}></span>
<TextContainerWithWrapWord
  data={{
        ...
        <div className="position-absolute single-text-71 d-flex">
          <div className="mr-2">
            <div className="img-66 ml-3 d-flex justify-content-center align-items-center">
              <div className="line-circle digital-tag mt-1 p-2 grey-color"></div>
              </div>
              <TextContainerWithWrapWord
  data={{
    useClass: "text-dark mt-2",
 ...
 />
       ...
       <PipeWithCircles
         parentDivClass="pipe dotted-pipe"
         firstCircle={{
           firstCircleClass: `dot grayDot ${("RM_362BE1")} `,
           firstCircleText: "M",
         }}
       />
     ...
     <div className="position-absolute single-text-75">
      <div>
        ...
        <div>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-2 mx-auto ${useColorStatus("SM_592BE1_BMS")}`}
          text="BMS"
          label="SM_592BE1_BMS"
        /></div>
        </div><div className="d-flex mt-2">
          <div className="dot digital-tag mt-1 p-2 grey-color ">M</div>
         
          <div>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-2 ${useColorStatus("SM_592BE1_ZS")}`}
          label="SM_592BE1_ZS"
        /></div>
           <div>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-3 ${useColorStatus("SM_592BE1_TS")}`}
          label="SM_592BE1_TS"
        /></div>
          </div>
          <div className="d-flex mt-2">
            ...
            <div>
    <MotorCircleDigitalTag
          className={`square digital-tag mt-2 ${useColorStatus("SM_592BE1_BSS3_ALM")}`}
          text="BSS3A"
        ...
        />
            ...
            <div>
    <MotorCircleDigitalTag
          className={`square digital-tag mt-2 ml-3 ${useColorStatus("SM_592BE1_BSS4_ALM")}`}
          text="BSS4A"
        ...
        />
            ...
            <div className="d-flex">
              ...
              <div>
    <MotorCircleDigitalTag
          className={`square digital-tag mt-2 ${useColorStatus("SM_592BE1_BSS3")}`}
          text="BSS3T"
        ...
        />
              ...
              <div>
    <MotorCircleDigitalTag
          className={`square digital-tag mt-2 ml-3 ${useColorStatus("SM_592BE1_BSS4")}`}
          text="BSS4T"
        ...
        />
              ...
              <div className="d-flex mt-4">
                ...
                <div>
    <MotorCircleDigitalTag
          className={`square digital-tag mt-2 ${useColorStatus("SM_592BE1_BSS1_ALM")}`}
          text="BSS1A"
        ...
        />
                ...
                <div>
    <MotorCircleDigitalTag
          className={`square digital-tag mt-2 ml-3 ${useColorStatus("SM_592BE1_BSS2_ALM")}`}
          text="BSS2A"
        ...
        />
                  ...
                  <div>
    <MotorCircleDigitalTag
          className={`square digital-tag mt-2 ${useColorStatus("SM_592BE1_BSS1")}`}
          text="BSS1T"
        ...
        />
                  ...
                  <div>
    <MotorCircleDigitalTag
          className={`square digital-tag mt-2 ml-3 ${useColorStatus("SM_592BE1_BSS2")}`}
          text="BSS2T"
 ...
 />
        ...
        <div className="containerImage text-center ml-2">
          ...
          <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-1 ${useColorStatus("SM_612SI2_LS")}`}
          label="SM_612SI2_LS"
        /></span>
</div>
<TextContainerWithWrapWord
   ...
   <BlackContainer
      ...
      <div className="position-absolute single-text-80 d-flex">
       ...
       <div className="containerImage text-center ml-2">
         ...
         <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-1 ${useColorStatus("SM_612SI1_LS")}`}
          label="SM_612SI1_LS"
        /></span>
</div>
<TextContainerWithWrapWord
...
<BlackContainer
         ...
         />
<div className="img-97 d-flex justify-content-center  align-items-end"><span className={`line-circle grey-color   ${("51RF2_MR")}`}></span></div>
<TextContainerWithWrapWord
          data={{
            useClass: "text-dark mt-2 ",
            label: "592FN2",
...
<BlackContainer
         ...
         />
<div className="img-97 d-flex justify-content-center  align-items-end"><span className={` line-circle grey-color greenDot ${("51RF2_MR")}`}></span></div>
...
<BlackContainer
  ...
  <div className="d-flex">
         <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562SD1_ECLS")}`}
          label="SM_562SD1_ECLS"
        /></span>
        <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-2 ${useColorStatus("SM_562SD1_EOLS")}`}
          label="SM_562SD1_EOLS"
        /></span>
         </div>
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562SD1_OLS", closeLabel: "SM_562SD1_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
  ...
  <div>
        <div>
          ...
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`dot digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_562LD1_OLS", closeLabel: "SM_562LD1_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
        ...
        <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_562LD1_ECLS")}`}
          label="SM_562LD1_ECLS"
        /></span>
        <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-2 ${useColorStatus("SM_562LD1_EOLS")}`}
  ...
  <div className="d-flex">
         <span>
         <MotorCircleDigitalTag
          className={`square digital-tag mt-1 mx-auto ${useColorStatus("SM_592SM1_ZSS")}`}
          label="SM_592SM1_ZSS"
        /></span>
         </div>
        <div>
          ...
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`square digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_592SG1_OLS", closeLabel: "SM_592SG1_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
        ...
        <span className={`greenSqure position-absolute single-text-88 mt-1 mx-auto ${"51RF2_MR"}`}>M</span>
 ...
 <MimicCaret
     parentClass="tringle-item"
     firstCaretClass={`fa-solid fa-caret-down  d-block digital-tag ${(
      { openLabel: "SM_592BV2_OLS", closeLabel: "SM_592BV2_CLS" }
    )}`}
     secondCaretClass={`fa-solid fa-caret-up  d-block digital-tag  ${(
      { openLabel: "SM_592BV2_OLS", closeLabel: "SM_592BV2_CLS" }
    )}`}
 ...
 <MimicCaret
     parentClass="tringle-item"
     firstCaretClass={`fa-solid fa-caret-down  d-block digital-tag ${(
      { openLabel: "SM_592BV9_OLS", closeLabel: "SM_592BV9_CLS" }
    )}`}
     secondCaretClass={`fa-solid fa-caret-up  d-block digital-tag  ${(
      { openLabel: "SM_592BV9_OLS", closeLabel: "SM_592BV9_CLS" }
    )}`}
 ...
 <MimicCaret
     parentClass="tringle-item"
     firstCaretClass={`fa-solid fa-caret-down  d-block digital-tag ${(
      { openLabel: "SM_592BVA_OLS", closeLabel: "SM_592BVA_CLS" }
    )}`}
     secondCaretClass={`fa-solid fa-caret-up  d-block digital-tag  ${(
      { openLabel: "SM_592BVA_OLS", closeLabel: "SM_592BVA_CLS" }
    )}`}
   ...
   <span class="dot greenDot mt-1 p-2 RM_362BC2 "></span>
   <div class="yellowline-Vr downArrow position-absolute line-24a"></div>
   </div>

   <div className="position-absolute single-text-94 d-flex">
  
 <span className={`dot greenDot ${"51RF2_MR"}`}>M</span>
 <span>
 <MotorCircleDigitalTag
          className={`square digital-tag ml-2 ${useColorStatus("SM_562BE1M01_ZS1")}`}
          label="SM_562BE1M01_ZS1"
        />
 </span>
 <span>
 <MotorCircleDigitalTag
          className={`square digital-tag ml-4 mt-4 ${useColorStatus("SM_562BE1_TS1")}`}
          label="SM_562BE1_TS1"
        />
 </span>
 <span className="ml-5 mt-4">
        <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-2 ${useColorStatus("SM_562DC1_ZSS")}`}
          text="ZSS"
          label="SM_562DC1_ZSS"
        /></span>
   ...
   <span className=" mt-2">
        <MotorCircleDigitalTag
          className={`square digital-tag mt-1 ml-2 ${useColorStatus("SM_562BE1_BMS1")}`}
          text="BMS"
        ...
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`square digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_592SG4_OLS", closeLabel: "SM_592SG4_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
      ...
      <div className="position-absolute single-text-99 ">
        ...
        <div>
          <div className="dot-square-line d-flex flex-column align-items-center">
          <div className={`square digital-tag ${useDampersValveTagsColorStatusForNewPlantScreens({ openLabel: "SM_592SG3_OLS", closeLabel: "SM_592SG3_CLS" })}`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div>
        </div>
      ...
      <div className="position-absolute single-text-100">
                  <div>
    <MotorCircleDigitalTag
          className={`square digital-tag mt-2 ${useColorStatus("SM_592BE1_LS1")}`}
          text="BLLS"
          label="SM_592BE1_LS1"
        />
    </div>
    <div>
    <MotorCircleDigitalTag
          className={`square digital-tag mt-2 ${useColorStatus("SM_592BE1_LS2")}`}
          text="BLLS"
          label="SM_592BE1_LS2"
        />
    </div>
      ...
      <span>
         <MotorCircleDigitalTag
          className={`square digital-tag ml-1 ${useColorStatus("SM_592BF1_DPT")}`}
          label="SM_592BF1_DPT"
        /></span>
           <span>
         <MotorCircleDigitalTag
          className={`square digital-tag ml-1 ${useColorStatus("SM_592BF1_PT")}`}
          label="SM_592BF1_PT"
        /></span>
           </div> 
      ...
      <span>
         <MotorCircleDigitalTag
          className={`square digital-tag ml-1 ${useColorStatus("SM_592BF2_DPT")}`}
          label="SM_592BF2_DPT"
        /></span>
           <span>
         <MotorCircleDigitalTag
          className={`square digital-tag ml-1 ${useColorStatus("SM_592BF2_PT")}`}
          label="SM_592BF2_PT"
        /></span>
           </div>   
           <div className="position-absolute single-text-103" >
           <span><MotorCircleDigitalTag
          className={`square digital-tag ml-5 ${useColorStatus("SM_562SG2_EOLS")}`}
