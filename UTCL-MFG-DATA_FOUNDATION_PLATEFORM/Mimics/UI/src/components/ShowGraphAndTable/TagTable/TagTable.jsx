                        ...
                        <tr className="bg-gradient-to-r from-orange-400 to-orange-300">
                            {headers.map((key) => (
                                <th
                                    ...
                                    className="cursor-pointer px-2 py-1 text-[13px]  text-[#111111] whitespace-nowrap text-center"
                                >
                                    ...
                                    {headers.map((header, i) => (
                                        <td
                                            className={`px-2 py-1 ${i === 0 || i === 1
                                                ? "max-w-[160px] truncate overflow-hidden text-ellipsis text-[13px] text-wrap"
