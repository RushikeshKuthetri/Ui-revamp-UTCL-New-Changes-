...
export const ReactFlowRenderer = ({
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        const offset = 80; // tweak here

        setViewport({
          x: x - offset,
          y,
          zoom: zoom * 1.1, // 🔥 slight zoom boost (optional)
        });
      }, 50);
  ...
  return (
    <div className="h-full w-full relative bg1" >
      {/* <div
        className={
          vikramPlantCondition ? "row UHDashboardVikram" : "row mainContainer"
        }
        ...
        >
          ...
          <Controls
            ...
            onFitView={() => {
              ...
              // Step 2: apply SAME logic as initial render
              setTimeout(() => {
                const { x, y, zoom } = getViewport();
