...
import "../../HO/MillRunning/MillRunningPage.scss";
import { getHoTagDetails } from "../../../utils/apicalls/centralisedDashboard";

export const MillRunningHOPPage = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        dispatch({
          type: "INSERT_HO_PROJECT_TABLE_DATA",
          payload: response,
        });
    ...
    <section className="mill-running cd_table_bg px-2">
      {centralisedDashboardData.loader ? (
        ...
        <div className="h-100">
          ...
          <div className="table-responsive mt-4 border border-secondary text-nowrap">
            <CentralTable />
          </div>
          <CentralTableLegend />
        </div>
