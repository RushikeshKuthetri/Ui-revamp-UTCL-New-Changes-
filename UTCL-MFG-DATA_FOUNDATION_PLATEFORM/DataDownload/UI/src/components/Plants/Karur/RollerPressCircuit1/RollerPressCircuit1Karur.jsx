...
export const RollerPressCircuit1Karur = () => {
  return (
    <div className="RollerPressCircuit1Karur  w-100 h-100 position-relative">
      <PipeWithCircles
      ...
      <PipeWithCircles
        ...
        text={{ useClass: "text-dark", label: "531WF4" }}
        secondCircle={{
          secondCircleClass: `dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
      ...
      <PipeWithCircles
        ...
        text={{ useClass: "text-dark", label: "561SC2" }}
        secondCircle={{
          secondCircleClass: `dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
      ...
      <div className="yellowline-Vr upArrow position-absolute pipe-109"></div>
      ...
      <div className="yellowline-Vr downArrow position-absolute pipe-126"></div>
      ...
      <div className="dashedHr-Pipe position-absolute pipe-135 ">
        <div className="text-center">
          <TextContainerWithWrapWord
            data={{
              useClass: "text-dark",
      ...
      {/* <div className="yellowline-Vr position-absolute pipe-138"></div> */}
      <div className="yellowline-Vr downArrow position-absolute pipe-139"></div>
      <div className="yellowline-Vr upArrow position-absolute pipe-140"></div>
      <div className="yellowline-Vr upArrow position-absolute pipe-141"></div>
        ...
        <div className="text-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              { runLabel: "CM_532WF2_RUN", healthyLabel: "CM_532WF2_PH" }
            )}`}
            label="CM_532WF2_RUN"
          />
          <TextContainerWithWrapWord
      ...
      <div className="position-absolute single-text-26 d-flex">
        <div className="yellowpolygon d-flex justify-content-center align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              { runLabel: "NA", healthyLabel: "NA" }
            )}`}
      ...
      <div className=" position-absolute single-text-54 text-center">
        <BlackContainer
          data={{
            label: "CM_591BF1_DPT",
            useClass: "greenTxt",
      ...
      <div className="position-absolute single-text-65 d-flex">
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CM_531SG2_ECLS")}`}
          label="CM_531SG2_ECLS"
        />
        <MotorCircleDigitalTag
          className={`square digital-tag ${useColorStatus("CM_531SG2_EOLS")}`}
          label="CM_531SG2_EOLS"
        />
      </div>
      ...
      <div className="position-absolute single-text-76 d-flex flex-column">
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_561SG5_ECLS")}`}
            label="CM_561SG5_ECLS"
          />
          <MotorCircleDigitalTag
            className={`square digital-tag ml-3 ${useColorStatus(
              "CM_561SG5_EOLS"
            )}`}
            label="CM_561SG5_EOLS"
          />
        </div>
      </div>
      ...
      <div className="position-absolute single-text-87 d-flex">
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_591GA1_CLS")}`}
            label="CM_591GA1_CLS"
          />
          <MotorCircleDigitalTag
            className={`square digital-tag ml-3 ${useColorStatus(
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_591GA2_CLS")}`}
            label="CM_591GA2_CLS"
          />
          <MotorCircleDigitalTag
            className={`square digital-tag ml-3 ${useColorStatus(
      ...
      <div className="position-absolute single-text-95 d-flex">
        <div className="text-center">
          <MotorCircleDigitalTag
            className={`line-circle digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              { runLabel: "CM_591FN7_RUN", healthyLabel: "CM_591FN7_PH" }
            )}`}
            label="CM_591FN7_RUN"
          />
          <TextContainerWithWrapWord
        ...
        <div className="text-center">
          <MotorCircleDigitalTag
            className={`line-circle digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              { runLabel: "CM_591FN7A_RUN", healthyLabel: "CM_591FN7A_PH" }
            )}`}
            label="CM_591FN7A_RUN"
          />
          <TextContainerWithWrapWord
            data={{
              useClass: "text-dark ",
      ...
      <div className="position-absolute single-text-100 d-flex">
        <div className="text-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "CM_561LQ4_M01_RUN",
                healthyLabel: "CM_561LQ4_M01_PH",
              }
            )}`}
        ...
        <div className="text-center ml-1">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "CM_561LQ4_M02_RUN",
                healthyLabel: "CM_561LQ4_M02_PH",
              }
            )}`}
      ...
      <div className="position-absolute single-text-101 d-flex">
        ...
        <MotorCircleDigitalTag
          className={`dot digital-tag ml-2 ${useMotorTagsColorStatusForNewPlantScreens(
            { runLabel: "CM_561SR1_M01_RUN", healthyLabel: "CM_561SR1_M01_PH" }
          )}`}
        ...
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useGateTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CM_561LD2_OLS",
                closeLabel: "CM_561LD2_CLS",
                healthyLabel: "CM_561LD2_PH",
              }
            )}`}
            label="CM_561LD2_OLS"
          />
      ...
      <div className="d-flex position-absolute single-text-117 flex-column">
        ...
        <div className="d-flex  align-items-center t">
          ...
          />
          {/* <div className="dot-square-line d-flex flex-column align-items-center ml-4">
            <div className={`dot digital-tag grey-color`}></div>
            <div className="yellowline-Vr position-relative"></div>
            <div className={`square grey-color`}></div>
          </div> */}
        </div>
      ...
      <div className="d-flex position-absolute single-text-129 align-items-center">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useGateTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CM_561LD1_OLS",
                closeLabel: "CM_561LD1_CLS",
                healthyLabel: "CM_561LD1_PH",
              }
            )}`}
            label="CM_561LD1_OLS"
          />
      ...
      <div className="d-flex position-absolute single-text-130 align-items-center">
        <div className="dot-square-line d-flex flex-column align-items-center">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useGateTagsColorStatusForNewPlantScreens(
              {
                openLabel: "CM_561SD1_OLS",
                closeLabel: "CM_561SD1_CLS",
                healthyLabel: "CM_561SD1_PH",
              }
            )}`}
            label="CM_561SD1_OLS"
          />
      ...
      <div className="position-absolute single-text-134 d-flex">
        <div className="d-flex g">
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_591GA1A_CLS")}`}
            label="CM_591GA1A_CLS"
          />
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_591GA1A_OLS")}`}
            label="CM_591GA1A_OLS"
          />
        </div>
        <div className="d-flex g">
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_591GA1B_CLS")}`}
            label="CM_591GA1B_CLS"
          />
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_591GA1B_OLS")}`}
            label="CM_591GA1B_OLS"
          />
        </div>
        <div className="d-flex g">
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_591GA1C_CLS")}`}
            label="CM_591GA1C_CLS"
          />
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_591GA1C_OLS")}`}
            label="CM_591GA1C_OLS"
          />
        </div>
        <div className="d-flex g">
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_591GA1D_CLS")}`}
            label="CM_591GA1D_CLS"
          />
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_591GA1D_OLS")}`}
            label="CM_591GA1D_OLS"
          />
        </div>
      </div>
      <div className="position-absolute single-text-135 d-flex">
        <div className="d-flex align-items-start">
          <div className="dot-square-line d-flex flex-column align-items-center">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                {
                  openLabel: "CM_551LD2_OLS",
                  closeLabel: "CM_551LD2_CLS",
                  healthyLabel: "CM_551LD2_PH",
                }
              )}`}
              label="CM_551LD2_OLS"
            />
        ...
        <div className="d-flexalign-items-start">
          <div className="dot-square-line d-flex flex-column align-items-center">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                {
                  openLabel: "CM_551LD1_OLS",
                  closeLabel: "CM_551LD1_CLS",
                  healthyLabel: "CM_551LD1_PH",
                }
              )}`}
              label="CM_551LD1_OLS"
            />
        ...
        <div className="d-flexalign-items-start">
          <div className="dot-square-line d-flex flex-column align-items-center">
            <MotorCircleDigitalTag
              className={`dot digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                {
                  openLabel: "CM_551SD1_OLS",
                  closeLabel: "CM_551SD1_CLS",
                  healthyLabel: "CM_551SD1_PH",
                }
              )}`}
              label="CM_551SD1_OLS"
            />
      ...
      <div className="position-absolute single-text-136 d-flex">
        <div className="d-flex ">
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_551LD2_ECLS")}`}
            label="CM_551LD2_ECLS"
          />
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus(
              "CM_551LD2_EOLS"
            )} ml`}
            label="CM_551LD2_EOLS"
          />
        </div>
        <div className="d-flex ">
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_551LD1_EOLS")}`}
            label="CM_551LD1_EOLS"
          />
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus(
              "CM_551LD1_ECLS"
            )} ml`}
            label="CM_551LD1_ECLS"
          />
        </div>
        <div className="d-flex ">
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus("CM_551SD1_EOLS")}`}
            label="CM_551SD1_EOLS"
          />
          <MotorCircleDigitalTag
            className={`square digital-tag ${useColorStatus(
              "CM_551SD1_ECLS"
            )} ml`}
            label="CM_551SD1_ECLS"
          />
        </div>
      </div>
      <MotorCircleDigitalTag
        className={`dot digital-tag ${useColorStatus(
          "NA"
        )} position-absolute single-text-137`}
        label="NA"
      />
      <TextContainerWithWrapWord
        data={{
          useClass: "text-dark  position-absolute single-text-138 bg-secondary",
          label: "TO SILO",
        }}
      />
