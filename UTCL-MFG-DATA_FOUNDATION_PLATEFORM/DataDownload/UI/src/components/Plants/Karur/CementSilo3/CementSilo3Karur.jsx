...
export const CementSilo3Karur = () => {
  return (
    <div className="CementSilo3Karur CementSilo1Kukurdih CS3Kukurdih w-100 h-100 position-relative">
              ...
              <div className="dot-square-line  ml-2 d-flex flex-column align-items-center">
                <MotorCircleDigitalTag
                  className={`square digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                    { openLabel: "PP_611SGM_OLS", closeLabel: "PP_611SGM_CLS" , healthyLabel: "PP_611SGM_PH" }
                  )}`}
                  label="PP_611SGM_OLS"
                />
          ...
          <div>
            ...
            <div className="d-flex">
              <div className="dot-square-line  ml-2 d-flex flex-column align-items-center">
                <MotorCircleDigitalTag
                  className={`square digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                    { openLabel: "PP_611SGP_OLS", closeLabel: "PP_611SGP_CLS", healthyLabel: "PP_611SGP_PH" }
                  )}`}
                  label="PP_611SGP_OLS"
                />
                <div className="yellowline-Vr position-relative"></div>
          ...
          <div>
            ...
            <div className="d-flex">
              <div className="dot-square-line  ml-2 d-flex flex-column align-items-center">
                <MotorCircleDigitalTag
                  className={`square digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                    { openLabel: "PP_611SGR_OLS", closeLabel: "PP_611SGR_CLS" , healthyLabel: "PP_611SGR_PH" }
                  )}`}
                  label="PP_611SGR_OLS"
                />
                <div className="yellowline-Vr position-relative"></div>
          ...
          <div>
            ...
            <div className="d-flex">
              <div className="dot-square-line  ml-2 d-flex flex-column align-items-center">
                <MotorCircleDigitalTag
                  className={`square digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                    { openLabel: "PP_611SGN_OLS", closeLabel: "PP_611SGN_CLS" , healthyLabel: "PP_611SGN_PH"}
                  )}`}
                  label="PP_611SGN_OLS"
                />
                <div className="yellowline-Vr position-relative"></div>
          ...
          <div>
            ...
            <div className="d-flex">
              <div className="dot-square-line  ml-2 d-flex flex-column align-items-center">
                <MotorCircleDigitalTag
                  className={`square digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                    { openLabel: "PP_611SGQ_OLS", closeLabel: "PP_611SGQ_CLS" , healthyLabel: "PP_611SGQ_PH"}
                  )}`}
                  label="PP_611SGQ_OLS"
                />
                <div className="yellowline-Vr position-relative"></div>
          ...
          <div>
            ...
            <div className="d-flex">
              <div className="dot-square-line  ml-2 d-flex flex-column align-items-center">
                <MotorCircleDigitalTag
                  className={`square digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                    { openLabel: "PP_611SGS_OLS", closeLabel: "PP_611SGS_CLS" , healthyLabel: "PP_611SGS_PH"}
                  )}`}
                  label="PP_611SGS_OLS"
                />
                <div className="yellowline-Vr position-relative"></div>
          ...
          <div>
            ...
            <div className="d-flex">
              <div className="dot-square-line  ml-2 d-flex flex-column align-items-center">
                <MotorCircleDigitalTag
                  className={`square digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                    { openLabel: "PP_611SGT_OLS", closeLabel: "PP_611SGT_CLS" , healthyLabel: "PP_611SGT_PH" }
                  )}`}
                  label="PP_611SGT_OLS"
                />
                <div className="yellowline-Vr position-relative"></div>
          ...
          <div>
            ...
            <div className="d-flex">
              <div className="dot-square-line  ml-2 d-flex flex-column align-items-center">
                <MotorCircleDigitalTag
                  className={`square digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                    { openLabel: "PP_611SGW_OLS", closeLabel: "PP_611SGW_CLS" , healthyLabel: "PP_611SGW_PH"}
                  )}`}
                  label="PP_611SGW_OLS"
                />
                <div className="yellowline-Vr position-relative"></div>
          ...
          <div>
            ...
            <div className="d-flex">
              <div className="dot-square-line  ml-2 d-flex flex-column align-items-center">
                <MotorCircleDigitalTag
                  className={`square digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                    { openLabel: "PP_611SGV_OLS", closeLabel: "PP_611SGV_CLS" , healthyLabel: "PP_611SGV_PH" }
                  )}`}
                  label="PP_611SGV_OLS"
                />
                <div className="yellowline-Vr position-relative"></div>
          ...
          <div>
            ...
            <div className="d-flex">
              <div className="dot-square-line  ml-2 d-flex flex-column align-items-center">
                <MotorCircleDigitalTag
                  className={`square digital-tag ${useGateTagsColorStatusForNewPlantScreens(
                    { openLabel: "PP_611SGU_OLS", closeLabel: "PP_611SGU_CLS" , healthyLabel: "PP_611SGU_PH"}
                  )}`}
                  label="PP_611SGU_OLS"
                />
                <div className="yellowline-Vr position-relative"></div>
      ...
      <div className="position-absolute single-text-59">
        <MimicCaret
          parentClass="tringle-item d-flex"
          firstCaretClass={`fa-solid fa-caret-right d-block digital-tag ${useBVTagsColorStatusForNewPlantScreens(
            { openLabel: "PP_611BV2F_OLS", closeLabel: "PP_611BV2F_CLS" }
          )}`}
          secondCaretClass={`fa-solid fa-caret-left d-block digital-tag ${useBVTagsColorStatusForNewPlantScreens(
            { openLabel: "PP_611BV2F_OLS", closeLabel: "PP_611BV2F_CLS" }
          )}`}
          label="PP_611BV2F_OLS"
        />
        <TextContainerWithWrapWord
          data={{
            useClass: "text-dark mt-2",
      ...
      <div className="position-absolute single-text-68 d-flex">
        <div className="d-flex">
          <div className="d-flex">
            ...
            <div className="mt-2 ml-5 position-absolute">
              <div>
                <TextContainerWithWrapWord
                  data={{
                    useClass: "text-dark mt-2 ",
      ...
      <div className="d-flex position-absolute single-text-72">
        <span>
          <MotorCircleDigitalTag
            className={`square digital-tag ml-1 ${useColorStatus("PP_611BF3_DPT")}`}
            label="PP_611BF3_DPT"
          />
        </span>
