...
import * as tagsData from "../../../../data/Kukurdih/TurbineTripLogic/kukurdihTurbineTripLogicTextcolumn";
import {
  useCaretColorStatus,
  useColorStatus,
...
export const TurbineTripLogickukurdih = () => {
  return (
    <div className="TurbineTripLogic-kotputli TurbineTripLogic-kukurdih w-100 h-100 position-relative">
      ...
      <div className="position-absolute single-text-29">
        <div className="d-flex justify-content-between">
          ...
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "W1_STG_MT_200_RUN",
                healthyLabel: "W1_STG_MT_200_PH",
              }
            )}`}
            text="M"
            label="W1_STG_MT_200_RUN"
          />
        </div>
        ...
        <div className="d-flex justify-content-between mt-4">
          <TextContainerWithWrapWord
            data={{
              useClass: "bg-light px-1 mr-2",
              label: "ACOP-2MOTOR IN AUTO AND RUNNING",
            }}
          />
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "W1_STG_MT_251_RUN",
                healthyLabel: "W1_STG_MT_251_PH",
              }
            )}`}
            text="M"
            label="W1_STG_MT_251_RUN"
          />
        </div>
        <div className="d-flex justify-content-between mt-4">
          <TextContainerWithWrapWord
          ...
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "W1_STG_MT_250_RUN",
                healthyLabel: "W1_STG_MT_250_PH",
              }
            )}`}
            text="M"
            label="W1_STG_MT_250_RUN"
          />
        </div>
        <div className="d-flex justify-content-between mt-4">
          <TextContainerWithWrapWord
          ...
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "W1_STG_MT_161_RUN",
                healthyLabel: "W1_STG_MT_161_PH",
              }
            )}`}
            text="M"
            label="W1_STG_MT_161_RUN"
          />
        </div>
        <div className="d-flex justify-content-between mt-4">
          <TextContainerWithWrapWord
          ...
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "W1_STG_MT_160_RUN",
                healthyLabel: "W1_STG_MT_160_PH",
              }
            )}`}
            text="M"
            label="W1_STG_MT_160_RUN"
          />
        </div>
        <div className="d-flex justify-content-between mt-4">
          <TextContainerWithWrapWord
          ...
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "W1_STG_MT_203_RUN",
                healthyLabel: "W1_STG_MT_203_PH",
              }
            )}`}
            text="M"
            label="W1_STG_MT_203_RUN"
          />
        </div>
        <div className="d-flex justify-content-between mt-4">
          <TextContainerWithWrapWord
          ...
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
              {
                runLabel: "W1_STG_MT_202_RUN",
                healthyLabel: "W1_STG_MT_202_PH",
              }
            )}`}
            text="M"
            label="W1_STG_MT_202_RUN"
          />
        </div>
      </div>
      ...
      <div className="d-flex justify-content-between position-absolute single-text-32">
        ...
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_SAHH_GOV")}`}
          label="W1_STG_SAHH_GOV"
          text="S"
        />
      </div>
      ...
      />
      <TextColumn
        list={tagsData.kukurdihTurbineTripLogicTextcolumn1}
        useClass="position-absolute single-text-54"
      />
      <TextColumn
        list={tagsData.kukurdihTurbineTripLogicTextcolumn2}
        useClass="position-absolute single-text-55"
      />
      <TextColumn
        list={tagsData.kukurdihTurbineTripLogicTextcolumn3}
        useClass="position-absolute single-text-56"
      />
      <TextColumn
        list={tagsData.kukurdihTurbineTripLogicTextcolumn4}
        useClass="position-absolute single-text-57"
      />
      <TextColumn
        list={tagsData.kukurdihTurbineTripLogicTextcolumn5}
      ...
      />
      <TextColumn
        list={tagsData.kukurdihTurbineTripLogicTextcolumn6}
        useClass="position-absolute single-text-60"
      />
      <TextColumn
        list={tagsData.kukurdihTurbineTripLogicTextcolumn8}
        useClass="position-absolute single-text-61"
      />
      <BlackContainer
        data={{
          label: "W1_STG_COC_PT_003",
      ...
      <div className="border p-1 position-absolute single-text-67">
        ...
        <div className="d-flex justify-content-between mt-2">
          ...
          />
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_GOV_RPM_H")}`}
            label="W1_STG_GOV_RPM_H"
            text="S"
          />
        </div>
        <div className="d-flex justify-content-between mt-2">
          ...
          />
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_SAH_OSTD")}`}
            label="W1_STG_SAH_OSTD"
            text="S"
          />
        </div>
        <div className="d-flex justify-content-between mt-2">
      ...
      <div className="border p-1 position-absolute single-text-68">
        <div className="d-flex justify-content-between">
          ...
          {/* <MotorCircleDigitalTag
            ...
            label="W2_STG_GOV_RST_CMD"
            text="I"
          /> */}
          <span className="dot grey-color">I</span>
        </div>
        <div className="d-flex justify-content-between mt-2">
          <TextContainerWithWrapWord
            data={{
      ...
      <TopLeftBox
        ...
        list={tagsData.kukurdihTurbineTripLogicTextcolumn7}
        headText={{ class: "text-dark mx-auto", text: "ALTERNATOR PARAMETER" }}
      />
      <div className="position-absolute single-text-70">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_COC_PS_004A")}`}
          label="W1_STG_COC_PS_004A"
          text="P"
        />
        <MotorCircleDigitalTag
        ...
        <MotorCircleDigitalTag
          ...
          label="W1_STG_COC_PS_004C"
          text="P"
        />
      </div>
      <div className="position-absolute single-text-71">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_LOC_PS_002A")}`}
          label="W1_STG_LOC_PS_002A"
          text="P"
        />
        <MotorCircleDigitalTag
          className={`dot mt-1 digital-tag ${useColorStatus(
        ...
        <MotorCircleDigitalTag
          ...
          label="W1_STG_MAS_PS_003C"
          text="P"
        />
      </div>
      <div className="position-absolute single-text-72">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_GOV_SHUT_PB")}`}
          label="W1_STG_GOV_SHUT_PB"
          text="E"
        />
        <MotorCircleDigitalTag
          className={`dot mt-1 digital-tag ${useColorStatus(
          ...
          label="W1_STG_86T_OPTD"
          text="X"
        />
      </div>
      <div className={`dot position-absolute single-text-73 green-color`}>
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_SAHH_OSTD")}`}
          label="W1_STG_SAHH_OSTD"
          text="S"
        />
      </div>
      <div className="position-absolute single-text-74">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_MAS_PS_001A")}`}
          label="W1_STG_MAS_PS_001A"
          text="P"
        />
        <MotorCircleDigitalTag
          className={`dot mt-1 digital-tag ${useColorStatus(
        ...
        <MotorCircleDigitalTag
          ...
          label="W1_STG_MAS_PS_001C"
          text="P"
        />
      </div>
      <div className="position-absolute single-text-75">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_MAS_PS_002A")}`}
          label="W1_STG_MAS_PS_002A"
          text="P"
        />
        <MotorCircleDigitalTag
          className={`dot mt-1 digital-tag ${useColorStatus(
      ...
      <div className="position-absolute single-text-77">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_86T_OPTD")}`}
          label="W1_STG_86T_OPTD"
          text="X"
        />
        <MotorCircleDigitalTag
      ...
      <div className="position-absolute single-text-78">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_PCS_ZAHH")}`}
          label="W1_STG_PCS_ZAHH"
          text="X"
        />
        <MotorCircleDigitalTag
          ...
          label="W1_STG_PCS_VAHH"
          text="V"
        />
        <MotorCircleDigitalTag
          className={`dot mt-5 digital-tag ${useColorStatus("W1_STG_TGCB_XO")}`}
          label="W1_STG_TGCB_XO"
          text="X"
        />
      </div>
      <div className="position-absolute single-text-79">
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus(
            "W1_STG_EOC_MT_001_REM"
          )}`}
          label="W1_STG_EOC_MT_001_REM"
          text="X"
        />
        <MotorCircleDigitalTag
          className={`dot mt-4 digital-tag ${useColorStatus(
            "W1_STG_LOC_201_LS"
          )}`}
          label="W1_STG_LOC_201_LS"
          text="L"
        />
        <MotorCircleDigitalTag
          className={`dot mt-5 digital-tag ${useColorStatus(
          ...
          label="W1_STG_SV270_RST"
          text="X"
        />
      </div>
      <div className={`position-absolute single-text-80 dot mt-3 green-color`}>
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_GOV_TRIP_SV")}`}
          label="W1_STG_GOV_TRIP_SV"
          text="X"
        />
      </div>
      <div className={`position-absolute single-text-81 dot mt-3 green-color`}>
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_TRIP")}`}
          label="W1_STG_TRIP"
          text="I"
        />
      </div>
      ...
      <div className="position-absolute single-text-84">
        {/* <MotorCircleDigitalTag
          ...
          text="X"
        /> */}
        <span className="dot grey-color">X</span>
        <MotorCircleDigitalTag
          className={`dot mt-1 digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
            { runLabel: "W1_STG_MT_250_RUN", healthyLabel: "W1_STG_MT_250_PH" }
          )}`}
          label="W1_STG_MT_250_RUN"
        />
        <MotorCircleDigitalTag
          className={`dot mt-1 digital-tag ${useMotorTagsColorStatusForNewPlantScreens(
            { runLabel: "W1_STG_MT_251_RUN", healthyLabel: "W1_STG_MT_251_PH" }
          )}`}
          label="W1_STG_MT_251_RUN"
        />
      ...
      />
      <MotorCircleDigitalTag
        className={`dot digital-tag position-absolute single-text-87 grey-color`}
        text="I"
        label=""
      />
    </div>
