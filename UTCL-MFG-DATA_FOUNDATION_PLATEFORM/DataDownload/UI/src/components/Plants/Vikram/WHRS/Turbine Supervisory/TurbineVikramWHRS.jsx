...
export const TurbineVikramWHRS = () => {
  return (
    <div className="TurbineAndhra Turbinevikram w-100 h-100 position-relative">
        ...
        <table className="w-100 table mb-0">
          ...
          <tr>
            <td>
              <TextContainerWithWrapWord
                data={{
                  useClass: "text-dark",
                  label: "LUBE OIL HEADER PR LL < 1.8",
                }}
              />
            </td>
            <td>
            ...
            <td>
              <MotorCircleDigitalTag
                className={`square px-2 text-dark digital-tag ${useColorStatus(
                  "W1_STG_LOC_507_PT_LO"
                )}`}
                label="W1_STG_LOC_507_PT_LO"
                text="L"
              />
            </td>
            <td>
              <MotorCircleDigitalTag
                className={`square px-2 text-dark digital-tag ${useColorStatus(
                  "W1_STG_LOC_507_PT_LL"
                )}`}
                label="W1_STG_LOC_507_PT_LL"
                text="LL"
              />
            </td>
            <td>
          ...
          <tr>
            <td rowSpan={3}>
              <TextContainerWithWrapWord
                data={{
                  useClass: "text-dark",
                  label: "TURBINE LAST STAGE TEMP HH > 235°C",
                }}
              />
            </td>
            <td>
          ...
          <tr>
            <td>
              <TextContainerWithWrapWord
                data={{
                  useClass: "text-dark",
                  label: "DRAIN POT LEVEL HH > 1200.0",
                }}
              />
            </td>
            <td>
          ...
          <tr>
            ...
            <td>
              <TextContainerWithWrapWord
                data={{
                  useClass: "text-dark",
                  label: "GEN DIFFERENTIAL -1 (D86B1)",
                }}
              />
            </td>
            <td></td>
          ...
          <tr>
            ...
            <td>
              <TextContainerWithWrapWord
                data={{
                  useClass: "text-dark",
                  label: "GEN DIFFERENTIAL -2 (D86D2)",
                }}
              />
            </td>
            <td> </td>
          ...
          <tr>
            ...
            <td>
              <TextContainerWithWrapWord
                data={{
                  useClass: "text-dark",
                  label: "EMERGENCY TRIP FROM TSP (EPB002)",
                }}
              />
            </td>
            <td></td>
          ...
          <tr>
            ...
            <td>
              <MotorCircleDigitalTag
                className={`square px-3 digital-tag ${useColorStatus(
                  "W1_STG_COC_PAL_PT_LL"
                )}`}
                label="W1_STG_COC_PAL_PT_LL"
              />
            </td>
          </tr>
          {/* 33 row */}
          ...
          <tr>
            <td>
              <TextContainerWithWrapWord
                data={{
                  useClass: "text-dark",
                  label: "OH. OIL TANK LEVEL NOT LOW>90%",
                }}
              />
            </td>
            <td>
      ...
      <div className="d-flex flex-column position-absolute single-text-5">
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_O86T1")}`}
            label="W1_STG_O86T1"
            text="P"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_O86T2")}`}
            label="W1_STG_O86T2"
            text="P"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_O86T3")}`}
            label="W1_STG_O86T3"
            text="P"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_O86T4")}`}
            label="W1_STG_O86T4"
            text="P"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_O86T5")}`}
            label="W1_STG_O86T5"
            text="P"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_O86T6")}`}
            label="W1_STG_O86T6"
            text="P"
          />
          <TextContainerWithWrapWord
      ...
      <div className="d-flex flex-column position-absolute single-text-6">
        ...
        />
        <MotorCircleDigitalTag
          className={`dot digital-tag ${useColorStatus("W1_STG_GOV002")}`}
          label="W1_STG_GOV002"
          text="P"
        />
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_GOV003")}`}
            label="W1_STG_GOV003"
            text="P"
          />
          <TextContainerWithWrapWord
      ...
      <div className="p-2 bg-secondary d-flex flex-column text-center position-absolute single-text-10">
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_D86A1")}`}
            label="W1_STG_D86A1"
            text="T"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_D86B1")}`}
            label="W1_STG_D86B1"
            text="T"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_D86A2")}`}
            label="W1_STG_D86A2"
            text="T"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_D86B2")}`}
            label="W1_STG_D86B2"
            text="T"
          />
          <TextContainerWithWrapWord
      ...
      <div className="p-2 bg-secondary d-flex flex-column text-center position-absolute single-text-11">
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_D86T1")}`}
            label="W1_STG_D86T1"
            text="T"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_D86T2")}`}
            label="W1_STG_D86T2"
            text="T"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_D86T3")}`}
            label="W1_STG_D86T3"
            text="T"
          />
          <TextContainerWithWrapWord
      ...
      <MotorCircleDigitalTag
        ...
        text="P"
      />
      <div className="p-2 bg-secondary d-flex flex-column text-center position-absolute single-text-13">
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_GCB_ON")}`}
            label="W1_STG_GCB_ON"
            text="T"
          />
          <TextContainerWithWrapWord
        ...
        <div className="d-flex">
          <MotorCircleDigitalTag
            className={`dot digital-tag ${useColorStatus("W1_STG_UCB_ON")}`}
            label="W1_STG_UCB_ON"
            text="T"
          />
          <TextContainerWithWrapWord
