...
export const routes = [
  // Dashboard Route
  {
    path: "/dashboard",
    component: MimicPage.Home,
    description: "This is the home page for Data Download",
  },
]