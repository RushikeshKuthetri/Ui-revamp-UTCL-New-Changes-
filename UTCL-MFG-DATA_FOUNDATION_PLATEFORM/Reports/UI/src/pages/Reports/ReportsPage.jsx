    ...
    <AuthenticatedTemplate>
      <div className="w-full bg-[var(--bg-main-container)]">
        <div className="flex">
          ...
          <button
            className="text-[14px] px-2.5 py-1 mr-1 rounded-lg !border !border-[var(--button-border)] bg-[var(--button-bg)]
            hover:bg-[var(--button-hover-bg)] focus:outline-none focus:ring-0 outline-none:
            text-[var(--text-color)] font-medium transition ml-auto cursor-pointer"
            onClick={() => {
              navigate("/reportList");
            }}
          >
        ...
        <div className="w-full rounded-2xl !border !border-[var(--form-border)] p-2 mt-1">
          ...
          <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 items-end">
            <div className="w-full">
              <label className="block mb-2 text-sm font-regular text-[var(--text-color)]">
              ...
              <input
                ...
                style={{ minWidth: "100% " }}
                className="w-full px-2 h-[35px] rounded-lg text-[13px]
...
disabled:cursor-not-allowed"
            ...
            <div className="w-full">
              <label className="block mb-2 text-sm text-[var(--text-color)]">
            ...
            <>
              ...
              {(selectedEmailFrequency === "Monthly" ||
                selectedEmailFrequency === "Weekly") && (
                  <>
                    <div className="w-full">
                      <label className="block mb-2 text-sm text-[var(--text-color)] placeholder-[var(--search-placeholder)]">
                        Start Date <span className="text-red-500">*</span>
                      </label>
                      <DatePicker
                        selected={startDate}
                        className="w-full px-3 py-[6px] text-[13px] rounded-lg outline-none bg-[var(--input-enable-bg)] !border !border-[var(--input-enable-border)] hover:!border-[var(--input-onhover-border)] transition-all duration-200 focus:border-[var(--input-onhover-border)] focus:ring-2 focus:ring-[var(--input-onhover-border)]"
                ...
                <>
                  <div className="w-full">
                    ...
                    <div className="relative">
                      <DatePicker
                        selected={startDate}
                        className="w-full px-3 py-[6px] text-[13px] placeholder-[var(--search-placeholder)] !border !border-[var(--input-enable-border)] hover:!border-[var(--input-onhover-border)] transition-all duration-200 rounded-lg outline-none bg-[var(--input-enable-bg)] focus:border-[var(--input-onhover-border)]focus:ring-2 focus:[var(--input-onhover-border)] transition-all"
                        wrapperClassName="w-full"
                        placeholderText="Click to select a date"
                        onChange={(date) => {
                          setStartDate(date);
                  ...
                  <div className="w-full">
                    ...
                    <div className="relative">
                      <DatePicker
                        selected={endDate}
                        placeholderText="Click to select a date"
                        className="w-full px-3 py-[6px] text-[13px] !border !border-[var(--input-enable-border)] hover:!border-[var(--input-onhover-border)] transition-all duration-200 rounded-lg outline-none bg-[var(--input-enable-bg)] focus:[var(--input-onhover-border)] focus:ring-2 focus:[var(--input-onhover-border)] transition-all"
                        wrapperClassName="w-full"
                        onChange={(date) => {
                          setEndDate(date);
                        }}
                    ...
                    <div className="w-full">
                      ...
                      <div className="relative">
                        <DatePicker
                          selected={endTime}
                          placeholderText="Click to select a date"
                          className="w-full h-[35px] px-2 text-[13px] !border !border-[var(--input-enable-border)] hover:!border-[var(--input-onhover-border)] transition-all duration-200 rounded-lg outline-none bg-[var(--input-enable-bg)] text-[var(--text-color)] focus:border-[var(--input-onhover-border)] transition-all"
                          wrapperClassName="w-full"
                          onChange={(date) => {
                            setEndTime(date);
                          }}
                    ...
                    <div className="w-full">
                      ...
                      <div className="relative">
                        <DatePicker
                          selected={startTime}
                          placeholderText="Click to select a date"
                          className="w-full h-[35px] px-2 text-[13px] !border !border-[var(--input-enable-border)] hover:!border-[var(--input-onhover-border)] transition-all duration-200 rounded-lg outline-none bg-[var(--input-enable-bg)] transition-all"
                          wrapperClassName="w-full"
                          onChange={(date) => {
                            setStartTime(date);
                          }}
...
`}
          ...
          <div className="mt-4 mb-2 flex justify-center">
            {submitLoader && loader}
            <button
              className="shrink-0 cursor-pointer px-3 py-1 rounded-md bg-[var(--submit-button-bg)] hover:bg-[var(--submit-button-hover-bg)] text-[#111111] text-[14px] font-medium transition-all duration-200"
              disabled={templateName === "" || submitLoader}
              onClick={() => SendData()}
            >
              {window.location.href.split("/").pop() === "editReportPage"
