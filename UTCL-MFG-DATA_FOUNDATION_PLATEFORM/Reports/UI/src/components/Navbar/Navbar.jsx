...
export function Navbar() {
  ...
  const signOutHandler = (instance) => {
    ...
    instance.logoutRedirect({
      postLogoutRedirectUri: "/", // 👈 this is the only change  addded by TRIDAI to logout and redirect to base URL
    }).catch((e) => {
      console.error(e);
    });
    // useLogout()
  ...
  return (
    <div className="w-full h-14 bg-[var(--bg-header)] px-6 flex items-center justify-between shadow-header-shadow-light dark:shadow-header-shadow-dark">
      {/* <div to="#" className="menu_bar">
        <FaBars className="bar" size={35} onClick={showSidebar} />
      </div> */}
