...
export const ReportsFilterCard = ({ showingInTrend, data }) => {
    ...
    const fetchDataHandler = async () => {
        ...
        try {
            ...
            const fetchData = async (payload) => {
                ...
                //   );
                try {
                    const response = await axios.post(`${BASE_URL}reports/getreportdata`,
                        payload,
                        {
                            responseType: 'json', // Assume API returns JSON
                            headers: {
            ...
            console.log("Initial data in ReportCard is===============================>", initialData?.reportsData);
            dispatch({ type: "SET_LAST_TREND_PAYLOAD", payload: initialData?.reportsData }); // Added to set last payload for trend chart
            ...
            setIsChartLoading(false);
            dispatch({ type: "LOADING_FALSE" });
            dispatch({ type: "SET_REPORTS_DATA", payload: initialData }); // Added to return this for REports data to redux
        } catch (error) {
