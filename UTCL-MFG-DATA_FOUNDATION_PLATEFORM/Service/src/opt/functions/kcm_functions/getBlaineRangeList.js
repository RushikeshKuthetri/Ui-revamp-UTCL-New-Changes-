...
getBlaineRangeList = (req) => {
  var responseObject = {};
 
  let paramaters = `@opt_type=?, @plant=?, @mill=?, @grade=?`;

  let replacementArray = [
    "Cement Mill Optimization"
  , req.body.Plant_Code, req.body.Mill, req.body.Grade];
  var Query = " exec [dbo].[sp_kcm_activeRange_getrecord_filter]" + paramaters;
...
module.exports = getBlaineRangeList;
