...
getDropDownFilter = (req) => {
  ...
  let paramaters = `@plant_code=?, @mill=?, @grade=?`;

  let replacementArray = [req.body.Plant_Code, req.body.Mill, req.body.Grade];
  var Query = " exec [dbo].[sp_modelmaster_detail]" + paramaters;
