...
getEquipmentFailureData = (req) => {
  var responseObject = {};
  let paramaters = `@plant_code=?, @kiln_no=?,@timestamp=?`;
  ...
  var Query = " exec [dbo].[sp_kiln_Equipment_Failure_details]" + paramaters;
...
module.exports = getEquipmentFailureData;
