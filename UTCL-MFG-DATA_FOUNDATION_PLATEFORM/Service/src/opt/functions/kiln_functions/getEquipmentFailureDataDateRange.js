...
getEquipmentFailureDataDateRange = (req) => {
  var responseObject = {};

  let paramaters = `@plant_code=?, @kiln_no=?,@start_date=?,@end_date=?`;
  ...
  var Query = " exec [dbo].[sp_kiln_Equipment_Failure_fetchdata_betweendatetime]" + paramaters;
...
module.exports = getEquipmentFailureDataDateRange;
