...
//       let tempOpionList = {}
//       allFilterData.map((v) => {
//         if (v.Plant_SAP_Code === val.value) {
//           tempOpionList[v.Kiln_No] = {
//             label: v.Kiln_No,
//             value: v.Kiln_No
//           }
//         }
...
//       "Grade": ""
//     };
//     let postUrl = process.env.REACT_APP_BASE_URL + "opt/kilnAdmin/getDropDownFilter";
...
//             tempPlatList[val.Plant_SAP_Code] = {
//               label: val.Plant_SAP_Code + "-" + val.Plant_Generic_Name,
//               value: val.Plant_SAP_Code
//             }
//           })
...
//       await axios
//         .post(
//           process.env.REACT_APP_BASE_URL + "opt/kilnAdmin/getKilnAlerts",
//           data,
//           {
//             headers: { Authorization: `Bearer ${token.token}` },
//           }
...
//     let postUrl = process.env.REACT_APP_BASE_URL + "opt/kilnAdmin/insertKilnAlert"
//     if(cardValues[val].id){
//        postUrl = process.env.REACT_APP_BASE_URL + "opt/kilnAdmin/updateKilnAlert"
//       payload = {
...
//     axios
//       .post(
//         process.env.REACT_APP_BASE_URL + "opt/kilnAdmin/deleteKilnAlert",
//         payload,
//         {
//           headers: { Authorization: `Bearer ${token.token}` },
//         }
...
//           <h3>Alert For Kiln Recommendation</h3>
//         </div>
//         <div>
...
const AlertForKiln = () => {
  ...
  const alertCard = (val, index) => {
    ...
    "/>
        ...
        <div className="flex flex-col gap-1">
          <label className="text-sm font-medium text-[var(--text-color)]">Time Interval (in Minutes)</label>
          <input
            name="TimeInterval"
            placeholder="Enter Time Interval"
            type="number"
...
disabled:opacity-50"
  ...
  return (
    <>
      {/* <Navbar /> */}
      <div className="h-full flex flex-col bg-[var(--bg-main-container)] ">
        <div className="flex text-[18px] font-medium font-poppins text-[var(--title)]">
          <h3>Alert For Kiln Recommendation</h3>
        </div>
        <div>
            ...
            <div className="sticky top-0 bg-[var(--bg-main-container)] z-10 grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
              <div >
                ...
                <Select
                  ...
                  styles={getCompactSelectStyles(false, false)}   // 👈 ADD THIS
                  name="plant"
                  value={selectedVlaues.plant !== "" && plantOptionList.filter((val) => val.value === selectedVlaues.plant)}
                  options={plantOptionList}
                  className="basic-multi-select l-2"
